...
def execute_experiment_locally(experiment_index):
    ...
    seed, inner_quantity_proportion, inner_length_proportion, env_name, experiment_mode, max_frames = get_sequence_of_parameters()[experiment_index]
    ...
    no = NestedOptimization("../../../results/evogym/data/", experiment_mode, experiment_index, env_name, max_frames, inner_quantity_proportion, inner_length_proportion, seed)
