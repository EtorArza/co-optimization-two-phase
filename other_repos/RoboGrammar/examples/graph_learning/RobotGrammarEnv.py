...
class RobotGrammarEnv:
    ...
    def get_reward(self, robot_graph, no):

        print("Reward oracle = ",self.enable_reward_oracle)
        ...
        if self.enable_reward_oracle:
            ...
            input_sequence, reward = simulate(robot, self.task, opt_seed, self.mpc_num_processes, episode_count = 1, no=no)
