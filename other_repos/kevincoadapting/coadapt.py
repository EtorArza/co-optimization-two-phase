...
class Coadaptation(object):
    ...
    def __init__(self, config):
        ...
        self._episode_length = self._config['steps_per_episode']
    ...
    def _training_loop(self, iterations, design_cycles, exploration_strategy):
        ...
        print("_training_loop. designs=",self._design_counter , "steps=", self.total_number_of_steps)
    ...
    def _intial_design_loop(self, iterations):
        ...
        for params in self._env.init_sim_params:
            ...
            self.initialize_episode()
            print("_intial_design_loop. designs=",self._design_counter , "steps=", self.total_number_of_steps)
